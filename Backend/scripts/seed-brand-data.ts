...
const CHANGE_SEEDS: ChangeSeed[] = [
  {
    title: 'TechCrunch profiles RivalScan as AI-native CI for SMBs',
    detail: 'TechCrunch published a feature on RivalScan covering the Brand Pulse launch and the gap between $20-a-month Google Alerts and $20k/year Crayon/Klue.',
    ...
    category: 'news',
    sentiment: 'positive',
    pageUrl: 'https://techcrunch.com/2026/05/rivalscan-ai-competitive-intel-smb/',
    citationTitle: "TechCrunch: 'RivalScan wants to be the Crayon for the rest of us'",
    citationUrl: 'https://techcrunch.com/2026/05/rivalscan-ai-competitive-intel-smb/',
    daysAgo: 2,
  },
  {
    title: 'The Information cites RivalScan in AI-native sales tooling roundup',
    detail: 'A paywalled feature on the rise of AI-native sales tooling lists RivalScan among five startups reshaping the competitive-intelligence category.',
  ...
  },
  {
    ...
    detail: 'VentureBeat ran a piece on RivalScan extending its monitoring engine to self-brand tracking with the Phase 23 Brand Pulse release.',
    ...
    category: 'product',
    sentiment: 'positive',
    pageUrl: 'https://venturebeat.com/ai/rivalscan-brand-pulse-launch/',
    citationTitle: 'VentureBeat: RivalScan launches Brand Pulse for self-monitoring',
    citationUrl: 'https://venturebeat.com/ai/rivalscan-brand-pulse-launch/',
    daysAgo: 8,
  },
  {
    title: 'Hacker News front page — Show HN: RivalScan',
    ...
    citationTitle: 'Show HN: RivalScan — competitive intel for SMBs',
    citationUrl: 'https://news.ycombinator.com/item?id=42068911',
    daysAgo: 11,
  },
  {
    title: 'Product Hunt #2 product of the day',
    detail: 'RivalScan finished #2 on Product Hunt for the day of launch with 680+ upvotes and a "Product Hunt Featured" badge.',
    ...
    category: 'social',
    sentiment: 'positive',
    pageUrl: 'https://www.producthunt.com/posts/rivalscan',
    citationTitle: 'Product Hunt: RivalScan',
    citationUrl: 'https://www.producthunt.com/posts/rivalscan',
    daysAgo: 12,
  },
  {
    title: 'Y Combinator newsletter highlights RivalScan',
    detail: 'YC\'s monthly portfolio update featured RivalScan in the "alums to watch" section, noting the Brand Pulse launch and the AI-driven research engine.',
  ...
  },
  {
    ...
    detail: 'LinkedIn announcement that RivalScan hired its first Head of Engineering, previously a staff engineer at Linear. Post has 1.4k reactions.',
    ...
    citationTitle: 'LinkedIn: RivalScan welcomes Head of Engineering',
  ...
  },
  {
    ...
    category: 'hiring',
    sentiment: 'positive',
    pageUrl: 'https://www.linkedin.com/posts/founding-designer-rivalscan',
    citationTitle: 'LinkedIn: Joining RivalScan as founding designer',
    citationUrl: 'https://www.linkedin.com/posts/founding-designer-rivalscan',
    daysAgo: 17,
  },
  {
    title: 'Series A rumour: term sheet from Tier-1 fund',
    detail: 'A widely-shared tweet from a SaaS analyst claims RivalScan has a term sheet from a Tier-1 fund for a ~$12M Series A. Unconfirmed.',
  ...
  {
    title: 'Sequoia partner publicly endorses RivalScan',
    detail: 'A Sequoia partner posted "the founders to watch in CI" on Twitter and named RivalScan first. 1.8k reposts.',
  ...
  },
  {
    ...
    category: 'product',
    sentiment: 'positive',
    pageUrl: 'https://rivalscan.com/blog/brand-pulse-launch',
    citationTitle: 'RivalScan blog: Introducing Brand Pulse',
    citationUrl: 'https://rivalscan.com/blog/brand-pulse-launch',
    daysAgo: 9,
  },
  {
    ...
    category: 'product',
    sentiment: 'positive',
    pageUrl: 'https://rivalscan.com/blog/battlecard-pdf',
    citationTitle: 'RivalScan blog: Battlecard PDF launch',
    citationUrl: 'https://rivalscan.com/blog/battlecard-pdf',
    daysAgo: 18,
  },
  {
    ...
    category: 'product',
    sentiment: 'positive',
    pageUrl: 'https://rivalscan.com/blog/predicted-moves',
    citationTitle: 'RivalScan blog: Predicted Moves',
    citationUrl: 'https://rivalscan.com/blog/predicted-moves',
    daysAgo: 21,
  },
  {
    title: 'Customer case study: ACME Co',
    detail: 'First named case study — ACME Co (mid-market e-commerce) credits RivalScan with surfacing a key pricing move 9 days ahead of internal sales intelligence.',
    ...
    category: 'news',
    sentiment: 'positive',
    pageUrl: 'https://rivalscan.com/customers/acme',
    citationTitle: 'RivalScan customer story: ACME Co',
    citationUrl: 'https://rivalscan.com/customers/acme',
    daysAgo: 16,
  },
  {
    title: 'Reddit r/SaaS thread asking about RivalScan',
    detail: 'A founder posted asking "anyone tried RivalScan vs Klue?" — generated 40+ comments mostly comparing pricing and SMB fit.',
    ...
    category: 'social',
    sentiment: 'neutral',
    pageUrl: 'https://www.reddit.com/r/SaaS/comments/rivalscan-vs-klue',
    citationTitle: 'r/SaaS: RivalScan vs Klue?',
    citationUrl: 'https://www.reddit.com/r/SaaS/comments/rivalscan-vs-klue',
    daysAgo: 4,
  },
  {
    title: 'SaaStr podcast mention',
    detail: 'A SaaStr podcast guest mentioned RivalScan as their go-to tool for tracking 3-5 specific competitors without enterprise spend.',
  ...
  {
    title: 'Comparative review: RivalScan vs Crayon vs Klue',
    detail: 'A SaaS reviewer published a 4-tool comparison putting RivalScan on top for SMB use cases but flagging the lack of API access on lower tiers.',
  ...
  },
  {
    ...
    category: 'product',
    sentiment: 'positive',
    pageUrl: 'https://rivalscan.com/blog/slack-beta',
    citationTitle: 'RivalScan blog: Slack alerts now in beta',
    citationUrl: 'https://rivalscan.com/blog/slack-beta',
    daysAgo: 19,
  },
  {
    ...
    category: 'hiring',
    sentiment: 'positive',
    pageUrl: 'https://www.linkedin.com/posts/gtm-hire-rivalscan',
    citationTitle: 'LinkedIn: New GTM hire announcement',
    citationUrl: 'https://www.linkedin.com/posts/gtm-hire-rivalscan',
    daysAgo: 20,
  },
  {
...
const FINDING_SEEDS: FindingSeed[] = [
  {
    ...
    categories: {
      news: [
        {
          title: 'Show HN: RivalScan',
          detail: 'A Show HN post introduced RivalScan to the wider technical community.',
        ...
        },
        {
          ...
          detail: 'RivalScan appeared in the YC alum directory under "AI tooling".',
      ...
      product: [
        {
          ...
          sourceUrl: 'https://rivalscan.com/blog/launch',
          importance: 3,
          sentiment: 'positive',
          timeSensitivity: 'historical',
        },
    ...
    categories: {
      news: [
        {
          ...
          detail: 'TechCrunch profiles RivalScan as AI-native CI for SMBs.',
          sourceUrl: 'https://techcrunch.com/2026/05/rivalscan-ai-competitive-intel-smb/',
          importance: 3,
          sentiment: 'positive',
        ...
        },
        {
          ...
          sourceUrl: 'https://venturebeat.com/ai/rivalscan-brand-pulse-launch/',
          importance: 2,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
        {
          ...
          detail: 'YC portfolio update featured RivalScan in "alums to watch".',
      ...
      product: [
        {
          ...
          sourceUrl: 'https://rivalscan.com/blog/brand-pulse-launch',
          importance: 3,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
        {
          ...
          sourceUrl: 'https://rivalscan.com/blog/battlecard-pdf',
          importance: 2,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
      ...
      funding: [
        {
          ...
          detail: 'A Sequoia partner publicly called RivalScan a "founder to watch".',
      ...
      hiring: [
        ...
        },
        {
          ...
          sourceUrl: 'https://www.linkedin.com/posts/founding-designer-rivalscan',
          importance: 1,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
      ...
      social: [
        ...
        },
        {
          ...
          sourceUrl: 'https://www.producthunt.com/posts/rivalscan',
          importance: 2,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
      ...
      news: [
        {
          ...
          detail: 'Premium-tier press placement listing RivalScan in 5 startups reshaping CI.',
        ...
        },
        {
          ...
          detail: 'RivalScan called best-for-SMB; API tier-gating critique flagged.',
        ...
        },
        {
          ...
          detail: 'Mid-market e-commerce credits RivalScan with a 9-day lead on a competitor pricing move.',
          sourceUrl: 'https://rivalscan.com/customers/acme',
          importance: 2,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
      ...
      hiring: [
        {
          ...
          sourceUrl: 'https://www.linkedin.com/posts/gtm-hire-rivalscan',
          importance: 2,
          sentiment: 'positive',
          timeSensitivity: 'recent',
        },
      ...
      social: [
        {
          ...
          detail: 'SaaS operator (~250k followers) called RivalScan "the only CI tool I\'d run as a solo founder".',
        ...
        {
          title: 'SaaStr podcast mention',
          detail: 'A guest cited RivalScan as their go-to CI tool for SMB.',
